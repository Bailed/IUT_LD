...
<?php
    if (isset($_REQUEST['uri'])) {
        ...
        } elseif ($graph->type() == 'etudiant:Etudiant') {
...
<dl>
  <dt>Name:</dt><dd><?= $graph->getLiteral($_REQUEST['uri'], "etudiant:nom") ?></dd>
  <dt>Homepage:</dt><dd><?=$graph->getLiteral($_REQUEST['uri'], "etudiant:prenom")?></dd>
</dl>
